...
| R6 | Juridique : textes non validés, identité manquante | Certaine tant que non fait | Élevé | Pages rédigées avec placeholders visibles et avertissement | Validation par un juriste (EXTERNAL-ACTIONS) |
...
- **Navigation de premier niveau non bridée par la CSP** : un script injecté pourrait théoriquement exfiltrer via une navigation ; pas de vecteur d'injection connu.
